                        ...
                        <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control input" id="time_hours" placeholder="Hours" name="time_hours" value="{{ old('time_hours') }}">
                                    <div class="error-div">{{ $errors->first('time_hours') }}</div>
                                </div>
                                <div class="form-group">
                                    <label for="time_mins" class="form-text">How many Minutes</label>
                                    <input type="number" class="form-control input" id="time_mins" placeholder="Mins" name="time_mins" value="{{ old('time_mins') }}">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control input" id="ingredients" placeholder="Ingredients" name="ingredients"  value="{{ old('ingredients') }}">
                                  <div class="error-div">{{ $errors->first('ingredients') }}</div>
                                </div>
                                <div class="form-group">
                                    <label for="instructions" class="form-text">Instructions</label>
                                    <input type="text" class="form-control input" id="instructions" placeholder="Instructions" name="instructions"  value="{{ old('instructions') }}">
